...
protected:
  ...
  //! 
  //! @details The firework's update event. In this function will keep track of all
  //!          particles, update their postion & velocity. If the first firework 
  //!          generated by `MyGLWidget::Constructor` end firing, this function will 
  //!          generate a new firework and keep track of it.
  void paintGL();
