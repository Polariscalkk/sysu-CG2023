...
void MyGLWidget::paintGL() {
  ...
  if (m_Particles[MAX_PARTICLES].active) {
    ...
    m_Particles[MAX_PARTICLES].x += 
      m_Particles[MAX_PARTICLES].xi / (m_Slowdown * 1000);
    m_Particles[MAX_PARTICLES].y += 
      m_Particles[MAX_PARTICLES].yi / (m_Slowdown * 1000);
    m_Particles[MAX_PARTICLES].z += 
      m_Particles[MAX_PARTICLES].zi / (m_Slowdown * 1000);
    ...
    // trigger: explosion
    if (m_Particles[MAX_PARTICLES].y > 10.0f 
        && m_Particles[MAX_PARTICLES].life > 0) {
    ...
    // if a firework end firing, generate another firework(trigger).
    else if (m_Particles[MAX_PARTICLES].y > 10.0f 
            && m_Particles[MAX_PARTICLES].life <= 0) {
      m_Particles[MAX_PARTICLES].active = true;
      m_Particles[MAX_PARTICLES].life = 1.0f;
      m_Particles[MAX_PARTICLES].fade = float(rand() % 100) / 1000.0f + 0.001;
      ...
      m_Particles[MAX_PARTICLES].r = 
        COLORS[m_Rainbow ? rand() % 12 : m_Color][0];
      m_Particles[MAX_PARTICLES].g = 
        COLORS[m_Rainbow ? rand() % 12 : m_Color][1];
      m_Particles[MAX_PARTICLES].b = 
        COLORS[m_Rainbow ? rand() % 12 : m_Color][2];
